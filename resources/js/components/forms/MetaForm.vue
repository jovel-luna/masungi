		...
		<transition name="fade">
			<div v-if="visible" class="row">
				<div class="form-group col col-sm-12 col-md-6">
					<label>Title</label> <small>(Max Length: 150 Characters)</small>
				...
				<div class="form-group col col-sm-12 col-md-12">
					<label>Description</label> <small>(Max Length: 150 Characters)</small>
				...
				<div class="form-group col col-sm-12 col-md-12">
					<label>Title</label> <small>(Max Length: 50 Characters)</small>
					<input v-model="meta.og_title" name="meta_og_title" type="text" class="form-control input-sm">
				</div>

				<div class="form-group col col-sm-12 col-md-12">
					<label>Description</label> <small>(Max Length: 50 Characters)</small>
