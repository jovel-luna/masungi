<template>
	<form-request :submit-url="submitUrl" @load="load" @success="fetch" confirm-dialog sync-on-success>
		...
		<card>
			<template v-slot:header>Links Pdf Contents</template>
			...
			<div class="row">
				<div class="form-group col-sm-12 col-md-12 ">
	                ...
	                <a class="btn btn-primary btn-sm" target="_blank" :href="item.document_path_url"><i class="fa fa-eye"></i> View Downloadble File</a>
