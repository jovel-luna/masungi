<template>
	<form-request :submit-url="submitUrl" @load="load" @success="fetch" confirm-dialog sync-on-success>
		...
		<card>
			<template v-slot:header> Features </template>
			...
			<template v-slot:footer>
                ...
                :message="'Are you sure you want to archive Feature #' + item.id + '?'"
                :alt-message="'Are you sure you want to restore Feature #' + item.id + '?'"
                :disabled="loading"
                @load="load"
                @success="fetch"
                @error="fetch"
