<template>
	<form-request :submit-url="submitUrl" @load="load" @success="fetch" confirm-dialog sync-on-success>
		...
		<card>
			<template v-slot:header> Complimentary Light Snack </template>
			...
			<template v-slot:footer>
                ...
                :message="'Are you sure you want to archive Complimentary Light Snack #' + item.id + '?'"
                :alt-message="'Are you sure you want to restore Complimentary Light Snack #' + item.id + '?'"
                :disabled="loading"
                @load="load"
                @success="fetch"
                @error="fetch"
