<template>
	<div >
		...
		<card>
			<template v-slot:header>Company Inquiry Information</template>

			<div class="row">
				<div class="form-group col-sm-12 col-md-6">
					<label> Name of Company/Organzation</label>
				...
				<div class="form-group col-sm-12 col-md-6">
					...
					<input v-model="item.purpose" name="purpose" type="text" class="form-control">
				</div>				
				<div class="form-group col-sm-12 col-md-6">
