...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.venues.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <venue-view
                        fetch-url="{{ route('admin.venues.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.venues.update', $item->id) }}"
                        ></venue-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.venues', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
