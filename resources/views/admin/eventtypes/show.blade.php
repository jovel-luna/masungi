...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.eventtypes.index') }}">Event Types</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.eventtypes.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <eventtypes-view
                        fetch-url="{{ route('admin.eventtypes.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.eventtypes.update', $item->id) }}"
                        ></eventtypes-view>                        
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.eventtypes', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
