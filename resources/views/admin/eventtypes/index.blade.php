...
@section('meta:title', 'Event Types')
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('admin.eventtypes.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <eventtypes-table
                            ref="table-1"
                            fetch-url="{{ route('admin.eventtypes.fetch') }}"
                            ></eventtypes-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('admin.eventtypes.fetch-archive') }}"
                            ></eventtypes-table>
                        </div>
                    </div>
                </div>
