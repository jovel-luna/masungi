...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Wedding Inquiries</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Wedding Inquiries</a></li>
                </ol>
            </div>
        </div>
    </section>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <weddinginquiries-table 
                            ref="table-1"
                            fetch-url="{{ route('admin.weddinginquiries.fetch') }}"
                            ></weddinginquiries-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('admin.weddinginquiries.fetch-archive') }}"
                            ></weddinginquiries-table>
                        </div>
                    </div>
                </div>
