...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.weddingvenues.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <weddingvenues-view
                        fetch-url="{{ route('admin.weddingvenues.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.weddingvenues.update', $item->id) }}"
                        ></weddingvenues-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.weddingvenues', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
