...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.galleries.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <galleries-view
                        fetch-url="{{ route('admin.galleries.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.galleries.update', $item->id) }}"
                        ></galleries-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.galleries', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
