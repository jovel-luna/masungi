...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('admin.galleries.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <galleries-table
                            ref="table-1"
                            fetch-url="{{ route('admin.galleries.fetch') }}"
                            ></galleries-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('admin.galleries.fetch-archive') }}"
                            ></galleries-table>
                        </div>
                    </div>
                </div>
