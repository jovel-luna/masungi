...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.declarations.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <declarations-view
                        fetch-url="{{ route('admin.declarations.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.declarations.update', $item->id) }}"
                        :read-only="true"
                        ></declarations-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.declarations', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
