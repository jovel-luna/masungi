...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.awards.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <awards-view
                        fetch-url="{{ route('admin.awards.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.awards.update', $item->id) }}"
                        ></awards-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.awards', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
