...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.trailstops.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <trailstops-view
                        fetch-url="{{ route('admin.trailstops.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.trailstops.update', $item->id) }}"
                        ></trailstops-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.trailstops', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
