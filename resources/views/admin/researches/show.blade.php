...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.researches.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <researches-view
                        fetch-url="{{ route('admin.researches.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.researches.update', $item->id) }}"
                        ></researches-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.researches', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
