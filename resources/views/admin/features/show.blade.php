...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.features.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <features-view
                        fetch-url="{{ route('admin.features.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.features.update', $item->id) }}"
                        ></features-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.features', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
