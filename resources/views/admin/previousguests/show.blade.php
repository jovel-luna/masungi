...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.previousguests.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <previousguests-view
                        fetch-url="{{ route('admin.previousguests.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.previousguests.update', $item->id) }}"
                        ></previousguests-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.previousguests', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
