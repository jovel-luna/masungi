...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Company Inquiries</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Company Inquiries</a></li>
                </ol>
            </div>
        </div>
    </section>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <companyinquiries-table 
                            ref="table-1"
                            fetch-url="{{ route('admin.companyinquiries.fetch') }}"
                            ></companyinquiries-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('admin.companyinquiries.fetch-archive') }}"
                            ></companyinquiries-table>
                        </div>
                    </div>
                </div>
